...
const DriverPanel = () => {
    ...
    // Use ref to track isTracking state for closures
    ...
    const startLocationTracking = useCallback(() => {
        ...
        const id = navigator.geolocation.watchPosition(
            (position) => {
                ...
                // Use ref to check current tracking status within closure
                if (socket && isConnected && selectedBus && isTrackingRef.current) {
        ...
        setWatchId(id);
    }, [socket, isConnected, selectedBus, watchId]); // Removed isTracking dependency to avoid restarting watcher on state change

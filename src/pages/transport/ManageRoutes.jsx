      ...
      >
        <ModalContent>
          <ModalHeader className="flex gap-2 items-center">
            <Icon
              icon={editingRoute ? "mdi:pencil" : "mdi:plus-circle"}
              className="text-primary"
            />
          ...
          <ModalBody className="space-y-4 py-6">
            {error && (
              <div className="p-3 bg-danger-50 text-danger rounded-lg border border-danger-200 text-sm">
                {error}
              </div>
            )}
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="grid grid-cols-12 gap-2 items-end">
                ...
                <div className="col-span-3">
                  <Input
                    ...
                    value={newStop.lat}
                    onChange={(e) =>
                      setNewStop((p) => ({ ...p, lat: e.target.value }))
                    }
                    variant="bordered"
                    labelPlacement="outside"
                  />
                ...
                <div className="col-span-3">
                  <Input
                    ...
                    value={newStop.lng}
                    onChange={(e) =>
                      setNewStop((p) => ({ ...p, lng: e.target.value }))
                    }
                    variant="bordered"
                    labelPlacement="outside"
                  />
              ...
              <p className="text-xs text-default-400 px-1">
                Tip: Get coordinates from Google Maps by right-clicking on a
                location
              </p>
            </div>
          </ModalBody>

                                            ...
                                            <TableCell>
                                                {student.classInfo ? (
                                                    <Chip size="sm" variant="flat" color="secondary" classNames={{ content: "font-medium" }}>
                                                        {student.classInfo.name}-{student.sectionInfo.name}
                                                    </Chip>
                                                ) : '-'}
                                            </TableCell>
              ...
              <div className="flex items-center gap-3">
                <div className="p-2 bg-secondary-100 dark:bg-secondary-900/30 rounded-lg">
                  <Icon
                    ...
                    className="text-secondary-600 dark:text-secondary-400 text-2xl"
                  />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-foreground">
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-3 w-full">
                    <div
                      className={`p-2 rounded-lg bg-white dark:bg-white/10 shadow-sm text-${action.colorClass}-500`}
                    >
                    ...
                    <div className="text-left flex-1">
                      ...
                      <p className="text-xs text-default-500 opacity-80">
                        {action.subtitle}
                      </p>
                    </div>
                    <Icon
